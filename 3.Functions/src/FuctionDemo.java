...
public class FuctionDemo {
	...
	public static void main(String[] args) {
		...
		int val = 200;
		System.out.println(val);
		System.out.println(FuctionDemo.val);
		...
		if(one < two) {
			...
			// int one; error -> Duplicate local variable one
		}
		// System.out.println(three); this gives an error
		
		// Part 7 : Pass by Values
		System.out.println("Part 7 : Pass by Values");
		System.out.println(one+", "+two);
		swap(one, two);
		System.out.println(one+", "+two); // the values will not be swapped
